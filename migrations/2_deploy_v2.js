...
module.exports = async (deployer, network, accounts) => {
    ...
    let ProxyFactoryAddress = CONFIG.ProxyFactory;
    ...
    if (deploySwitch.DEPLOY_V2) {
        ...
        if (DODOSwapCalcHelperAddress == "") {
            // await deployer.deploy(DODOSwapCalcHelper);
        ...
        if (ProxyFactoryAddress == "") {
            ...
            logger.log("ProxyFactoryAddress: ", ProxyFactoryAddress);
        }
        ...
        if (DODORouteV2HelperAddress == "") {
            ...
            // await deployer.deploy(DODOV2RouteHelper);
        ...
        if (DODOV1AdpaterAddress == "") {
            ...
            // await deployer.deploy(DODOV1Adapter)
        ...
        if (network == 'omgx_rinkeby' || network == 'optimistic_kovan') {
            var tx;
